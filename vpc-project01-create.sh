...
echo "Public subnet created successfully with ID: $public_subnet_id"
...
echo "Private subnet created successfully with ID: $private_subnet_id"
...
echo "Internet gateway created successfully with ID: $internet_gateway_id"
...
echo "Route table created successfully with ID: $route_table_id"
...
echo "NAT gateway created successfully with ID: $nat_gateway_id"
...
echo "Private route table created successfully with ID: $private_route_table_id"
